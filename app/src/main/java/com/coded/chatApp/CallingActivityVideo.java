...
public class CallingActivityVideo extends BaseActivity {

    static final String TAG = CallingActivityVideo.class.getSimpleName();
    ...
    private class UpdateCallDurationTask extends TimerTask {
        ...
        @Override
        public void run() {
            CallingActivityVideo.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    updateCallDuration();
                }
